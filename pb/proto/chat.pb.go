...
type Message struct {
	...
	Timestamp     int64                  `protobuf:"varint,2,opt,name=timestamp,proto3" json:"timestamp,omitempty"` //дата отправки
...
const file_proto_chat_proto_rawDesc = "" +
	...
	"\x04Chat\x125\n" +
	"\vSendMessage\x12\x10.chat.v1.Message\x1a\x10.chat.v1.Message(\x010\x01B(Z&github.com/mariapizzeria/proto-chat/pbb\x06proto3"
...
var file_proto_chat_proto_depIdxs = []int32{
	0, // 0: chat.v1.Chat.SendMessage:input_type -> chat.v1.Message
	0, // 1: chat.v1.Chat.SendMessage:output_type -> chat.v1.Message
